...
This implementation renders these as flat colored hexagons. Cardinal elements use triangle symbols, salt uses `○`, vitae/mors use `+` and `−`, quicksilver uses `*`, and metals are labeled `1` through `6`:
...
The pack is generated by `scripts/generate-levels.mjs`.
